 ...
 */$(document).ready(function(){
	...
	$('ul.main-menu li a').each(function(){
		//alert(($(this))[0].href+"coucou");
		var test = String(window.location).split('/');
		//alert(test[3]);
		if($($(this))[0].href == "http://uf/"+test[3])
		{
...
function docReady(){
	...
	$('#session').dataTable({
			...
			"sPaginationType": "bootstrap",
			"bStateSave": true,
			"aoColumnDefs":[{ "sType": "date-uk", "aTargets": [5], "bSortable": true }]
	});
...
$(document).ready(function() {
	$('#session').dataTable( {
		"aoColumnDefs":[{ "sType": "date-uk", "aTargets": [4,5], "bSortable": true }]
	} );
} );
*/